...
class Pollution extends Component {
    ...
    fetchPosts() {
        ...
        axios.get('/posts/pollution').then(function (response) {
        ...
        return (
            <div className='d-flex text-center white-background'>
                <div className='w-100 border d-flex flex-column justify-content-center'>
                    <NavLink to='/forums/pollution'>Pollution</NavLink>
                    <div><small className='text-muted'>Discussions relating to pollution</small></div>
                </div>
